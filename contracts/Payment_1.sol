...
contract Payment {
     ...
     */
    function getCompletedUnits() public view returns (uint8) {
     ...
     */
    function getWithdrawnUnits() public view returns (uint8) {
     ...
     */
    function getUnitsLeftToBeWithdrawn() public view returns (uint8) {
    ...
    function addInvoice(
        ...
        contractorAddressInvoiceMap[_contractoraddress].push(newInvoice);
        contractorAddressInvoiceNumMap[_contractoraddress].push(_invoiceNumber);
    ...
    {
        return contractorAddressInvoiceCountMap[_contractoraddress];
    }
