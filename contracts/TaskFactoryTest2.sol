...
//     // function viewWorkerTasksAll() public view returns(TaskDetails[] memory _workerTaskDetails){
//     //     TaskDetails[] memory filtArr = new TaskDetails[](tasks.length);
//     //     uint64 currId = 0;
//     //     for (uint64 i; i < tasks.length; i++) {
...
//     ///@notice view worker tasks that are current (assigned but incomplete)
//     function viewWorkerCurrentTasks() public view returns(TaskDetails[] memory _workerTaskDetails){
//         TaskDetails[] memory filtArr = new TaskDetails[](tasks.length);
//         uint64 currId = 0;
//         for (uint64 i; i < tasks.length; i++) {
//             if (tasks[i].assignment() == msg.sender && tasks[i].approvedUnits() == tasks[i].progressUnits()) {
//                 filtArr[currId] = getTaskDetailsById(i);
//                 currId++;
//             }
//         }
...
//     // ///@notice view worker COMPLETED tasks
//     // function viewWorkerCompletedTasks() public view returns(TaskDetails[] memory _workerTaskDetails){
//     //     TaskDetails[] memory filtArr = new TaskDetails[](tasks.length);
//     //     uint64 currId = 0;
//     //     for (uint64 i; i < tasks.length; i++) {
//     //         if (tasks[i].approvedUnits() == tasks[i].progressUnits()) {
//     //             filtArr[currId] = getTaskDetailsById(i);
//     //             currId++;
//     //         }
//     //     }
...
//     // ///@notice view worker tasks that are awaiting acceptance to be assigned
//     // function viewWorkerAwaitingAcceptanceTasks() public view returns(TaskDetails[] memory _workerTaskDetails){
//     //     TaskDetails[] memory filtArr = new TaskDetails[](tasks.length);
//     //     uint64 currId = 0;
//     //     for (uint64 i; i < tasks.length; i++) {
//     //         if (tasks[i].approved() == msg.sender && tasks[i].isAssigned() == false) {
//     //             filtArr[currId] = getTaskDetailsById(i);
//     //             currId++;
//     //         }
//     //     }
